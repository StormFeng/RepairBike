...
public class AdapterGridViewPart extends BaseAdapter {

    private Context context;
    private List<String> str;
    private Map<Integer,Boolean> state=new HashMap<>();

    public AdapterGridViewPart(Context context, List<String> str, Map<Integer, Boolean> state) {
        this.context = context;
        this.str = str;
        this.state = state;
    }

    public AdapterGridViewPart(Context context, List<String> str) {
        this.context = context;
        this.str = str;
    ...
    public AdapterGridViewPart(Context context) {
        this.context = context;
    }
...
//                int number = Integer.valueOf(tv.getText().toString().trim());
                if(!state.get(position)){
