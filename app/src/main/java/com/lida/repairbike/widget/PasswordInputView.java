...
public class PasswordInputView extends EditText {
	...
	private int borderColor = 0xff949495;
	...
	protected void onDraw(Canvas canvas) {
		...
		borderPaint.setColor(Color.parseColor("#474A4E"));
...
//		float px, py = height / 2;
		float px, py = 50;
		float halfWidth = width / passwordLength / 3;
		for (int i = 0; i < textLength; i++) {
			px = width * i / passwordLength + halfWidth;
			String substring = temp.substring(i, i + 1);
//			LogUtils.e("substring: "+substring);
			canvas.drawText(substring,px,py,passwordPaint);
//			canvas.drawCircle(px, py, passwordWidth, passwordPaint);//画圆
		}
	}
